  ...
  <header>
    <nav id="navbar">
      <div class="container">
        ...
        <ul>
          <li><a class="current" href="index.php">Movies</a></li>
    ...
    <div id="showcase">
      <div class="container">
        <section class="left-showcase">
          <div id="deck">
            <div class="row">
              <div class="resize"><img src="./img/Movies/8988bf30657361a08fbbd3bd7a8fcda1.jpg" /></div>
              <div class="resize"><img src="./img/Movies/conjuring.jpg" /></div>
              <div class="resize"><img src="./img/Movies/fury.jpeg" /></div>
              <div class="clr"></div>
            </div>
            <div class="row">
              <div class="resize"><img src="./img/Movies/getout.jpg" /></div>
              <div class="resize"><img src="./img/Movies/star-is-born.jpg" /></div>
              <div class="resize"><img src="./img/Movies/inception.jpg" /></div>
              <div class="clr"></div>
            </div>
            <div class="row">
              <div class="resize"><img src="./img/Movies/legand.jpg" /></div>
              <div class="resize"><img src="./img/Movies/Transformers.jpg" /></div>
              <div class="resize"><img src="./img/Movies/zombieland_double_tap_ver2_xlg.jpg" /></div>
              <div class="clr"></div>
            </div>
          </div>
          <div class="clr"></div>
